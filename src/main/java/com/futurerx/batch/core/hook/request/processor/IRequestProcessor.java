...
public interface IRequestProcessor<R extends AbstractBatchRequest>
  ...
  @NonNull
  default IRequestProcessor<R> and(@NonNull IRequestProcessor<R> other) {
    var parent = this;
    return new IRequestProcessor<>() {
      @NonNull
      @Override
